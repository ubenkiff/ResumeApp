          ...
          <div key={exp.id} className="bg-slate-800 rounded-2xl shadow-xl p-6 border border-slate-700">
            <div className="flex justify-between items-start">
              ...
              <div className="flex gap-2 ml-4">
                <button onClick={() => handleEdit(exp)} className="text-blue-400 hover:text-blue-300 transition p-2">
                  <i className="fas fa-edit"></i>
                </button>
                <button onClick={() => handleDelete(exp.id)} className="text-red-400 hover:text-red-300 transition p-2">
