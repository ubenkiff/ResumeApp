        ...
        return (
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-slate-700 p-6 rounded-xl">
                <i className="fas fa-chart-line text-green-400 text-3xl mb-3"></i>
                <h3 className="text-white font-semibold">Statistics</h3>
                <p className="text-slate-400 text-sm">
                  {experience.length} Experience • {skills.length} Skills • {projects.length} Projects
                </p>
              </div>
              <div className="bg-slate-700 p-6 rounded-xl">
                <i className="fas fa-share-alt text-purple-400 text-3xl mb-3"></i>
    ...
    <div className="min-h-screen bg-slate-900 flex">
      ...
      <div className="w-64 bg-slate-800 shadow-md">
        ...
        <div className="absolute bottom-0 w-64 p-4 border-t border-slate-700">
          <button
            onClick={onLogout}
            className="block w-full text-left text-slate-400 hover:text-white py-2"
          >
