...
function PublicView() {
  ...
  if (loading) {
    return <div className="min-h-screen bg-slate-100 flex items-center justify-center">Loading portfolio...</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      <div className="no-print bg-slate-800 text-white px-6 py-3 flex justify-between sticky top-0 z-10">
        <a href="/" className="text-slate-300 hover:text-white">← Back to ResumeApp</a>
          ...
          <div className="p-10 print:p-8">
            ...
            <div className="border-b-2 border-blue-500 pb-4 mb-6">
              <div className="flex gap-6">
                {profile.avatar_url && (
                  <img src={profile.avatar_url} alt={profile.name} className="w-24 h-24 rounded-full object-cover border-2 border-blue-500" />
                )}
                      ...
                      {projects.map((project, idx) => (
                        <div key={project.id}>
                          <div className="flex gap-3 items-start">
                            {project.image_urls && project.image_urls[0] && <img src={project.image_urls[0]} className="w-10 h-10 rounded object-cover" />}
                            <div className="flex-1">
